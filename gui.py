...
def main():
    ...
    plt.ylabel("Минимум фитнес-функции")
    plt.savefig("graph.png")
    output_text2.delete(1.0, tk.END)
    output_text2.insert(tk.END, "Номер, Результат, Ген1, Ген2 \n")
...
right_frame = ttk.LabelFrame(root, padding=10, text="Хромосомы поколения")
...
chromoval_label = ttk.Label(frame1, text="Кол-во Хромосом")
